...
print("\n🔍 Testing Shares Outstanding API...")
...
# Compute P/E ratio (Price-to-Earnings Ratio) using shares outstanding
...
merged_df = merged_df.dropna(subset=["close", "p_e_ratio", "sma_50", "shares_outstanding"])
